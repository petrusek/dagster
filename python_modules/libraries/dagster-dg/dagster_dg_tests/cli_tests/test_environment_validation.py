...
# are repreesented in this file. Therefore when a new command is added to the CLI, it should be
# added to the appropriate list below. That will automatically mak sure the appropriate precondition
...
CODE_LOCATION_CONTEXT_COMMANDS = [
    CommandSpec(("code-location", "configure-vscode")),
...
def test_all_commands_represented_in_env_check_tests() -> None:
    ...
    # - `component scaffold` subcommands, because these are dynamically generated
